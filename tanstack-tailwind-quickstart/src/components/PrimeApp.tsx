      ...
      <main className="flex w-full flex-col gap-6">
        ...
        <div className="mx-auto flex w-full max-w-md flex-col gap-2 px-6">
          ...
          <p className="text-surface-500 dark:text-surface-400 text-pretty">
            A TanStack starter with Tailwind and dark mode. Every component in{" "}
            <code className="text-surface-700 dark:text-surface-200">components/ui</code>{" "}
            wraps a PrimeReact primitive and is styled with Tailwind + PrimeUI tokens.
          </p>
        </div>
              ...
              <Tabs defaultValue="signin">
                ...
                <TabsPanels>
                  <TabsPanel value="signin">
                    <div className="flex flex-col gap-4">
                      <div className="flex flex-col gap-1.5">
                        <label htmlFor="email" className="text-xs font-medium text-surface-700 dark:text-surface-300">
                          Email
                        </label>
                        <InputText id="email" type="email" placeholder="name@example.com" fluid />
                      </div>
                      <div className="flex flex-col gap-1.5">
                        <label htmlFor="password" className="text-xs font-medium text-surface-700 dark:text-surface-300">
                          Password
                        </label>
                        <InputText id="password" type="password" placeholder="Enter your password" fluid />
                      </div>
                  ...
                  <TabsPanel value="signup">
                    <div className="flex flex-col gap-4">
                      <div className="flex flex-col gap-1.5">
                        <label htmlFor="signup-email" className="text-xs font-medium text-surface-700 dark:text-surface-300">
                          Email
                        </label>
                        <InputText id="signup-email" type="email" placeholder="you@example.com" fluid />
                      </div>
                      <div className="flex flex-col gap-1.5">
                        <label htmlFor="signup-password" className="text-xs font-medium text-surface-700 dark:text-surface-300">
                          Password
                        </label>
                        <InputText id="signup-password" type="password" placeholder="Create a password" fluid />
                      </div>
                      <div className="flex justify-end pt-1">
