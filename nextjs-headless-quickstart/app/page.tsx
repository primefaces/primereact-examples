      ...
      <main className="flex w-full flex-col gap-6">
        ...
        <div className="mx-auto flex w-full max-w-md flex-col gap-2 px-6">
          ...
          <p className="text-neutral-500 dark:text-neutral-400 text-pretty">
            A headless starter with Tailwind and dark mode. Every component in{" "}
            <code className="text-neutral-700 dark:text-neutral-200">
              components/ui
            </code>{" "}
            is built from PrimeReact hooks and styled by you.
          </p>
        </div>

        {/* colorful box with the headless tabs card inside */}
        <div className="px-6">
